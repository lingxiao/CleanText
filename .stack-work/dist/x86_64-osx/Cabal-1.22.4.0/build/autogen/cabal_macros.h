...
/* package conduit-extra-1.1.9.2 */
#define VERSION_conduit_extra "1.1.9.2"
#define MIN_VERSION_conduit_extra(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 9)

/* package resourcet-1.1.7 */
#define VERSION_resourcet "1.1.7"
...
#define CURRENT_PACKAGE_KEY "Clean_0pEjWvA4UZU9s2xRj7FCxW"
